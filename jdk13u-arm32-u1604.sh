...
# boot jdk
#$D wget -nv https://github.com/ojdkbuild/contrib_jdk13u-ci/releases/download/jdk-13.0.${OJDK_UPDATE}%2B${OJDK_BUILD}/jdk-13.0.${OJDK_UPDATE}-ojdkbuild-linux-x64.zip
$D wget -nv https://github.com/ojdkbuild/contrib_jdk13u-ci/releases/download/jdk-13.0.${OJDK_UPDATE}.1%2B${OJDK_BUILD}/jdk-13.0.${OJDK_UPDATE}-ojdkbuild-linux-x64.zip
$D unzip -q jdk-13.0.${OJDK_UPDATE}-ojdkbuild-linux-x64.zip
$D mv jdk-13.0.${OJDK_UPDATE}-ojdkbuild-linux-x64 bootjdk

# cacerts
$D wget -nv ${OJDK_CACERTS_URL} -O cacerts

# sources
$D wget -nv http://hg.openjdk.java.net/jdk-updates/jdk13u/archive/${OJDK_TAG}.tar.bz2
